        ...
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full h-[48px] px-4 py-3 border-2 border-border hover:bg-muted/50 transition-colors flex items-center justify-center gap-2 font-medium"
            >
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-border hover:border-primary transition-colors disabled:opacity-50"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
